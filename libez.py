...
def on_change(x):
    ...
    # Pass all parameters in a single dictionary
    draw_lips(frame, **params)
...
def draw_lips(frame, px0=200, py0=200, fc=0.5, fp=0.8, width=100, vu=100, vc=40, vl=50, vp=50, amplitude=1.0):
    # Upper and Lower lip control points
    UMR0 = (px0 - width, py0)
    ...
    cv2.polylines(frame, [lower_lip_np], isClosed=False, color=(0, 255, 0), thickness=2)  # Green for lower lip
